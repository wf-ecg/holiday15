            ...
            switch (pn) {
                case 'eltoro':
                    writeIt('El Toro',
                        ...
                        '<img src="./images/pony/eltoro.svg"');
                    break;
                case 'mollie':
                    writeIt('Mollie',
                        ...
                        '<img src="./images/pony/mollie.svg"');
                    break;
                case 'snowflake':
                    writeIt('Snowflake',
                ...
                case 'prince':
                    writeIt('Prince',
                        ...
                        '<img src="./images/pony/prince.svg"');
                    break;
                case 'dandy':
                    writeIt('Dandy',
                ...
                case 'trixie':
                    writeIt('Trixie',
                        ...
                        '<img src="./images/pony/trixie.svg"');
                    break;
                case 'grace':
                    writeIt('Grace',
                ...
                case 'maggie':
                    writeIt('Maggie',
                        ...
                        '<img src="./images/pony/maggie.svg"');
                    break;
                case 'al':
                    writeIt('Al',
